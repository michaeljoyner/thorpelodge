...
@section('content')
    ...
    <section class="page-section location-section">
        ...
        <p>Thorpe Lodge is a well established venue nestled in the heart of KZN's sugar lands. Thorpe Lodge is just 2km outside the quaint little town of Wartburg.</p>
        <a href="" class="action-button centered">Google Maps</a>
        <img src="/images/map.png" alt="Map to Thorpe Lodge" class="map-image">
